...
<form name="updatePurchase" method="post"	action="/updatePurchase.do?tranNo=<%= purchase.getPurchaseProd().getProdNo()%>">
...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
		<input type="hidden" name="order_data" value=<%= purchase.getOrderDate() %>>
	</tr>
</table>
