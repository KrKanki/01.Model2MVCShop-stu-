...
1	buyer_id 					VARCHAR2(20)	NOT NULL REFERENCES users(user_id),
1	payment_option		CHAR(3),
1	receiver_name 		VARCHAR2(20),
1	receiver_phone		VARCHAR2(14),
1	demailaddr 				VARCHAR2(100),
...
INSERT INTO
product
values( seq_product_prod_no.nextval, 'a', 'b', '20140101', 5455, '1', sysdate);
