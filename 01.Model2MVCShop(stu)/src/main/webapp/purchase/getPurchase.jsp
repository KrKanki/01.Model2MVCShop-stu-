...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<% String payment= purchaseVO.getPaymentOption().trim().equals("1") ? "현금구매" : "신용구매" ; %>
			<%= payment %>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td name = "receiver_name" class="ct_write01"><%= purchaseVO.getReceiverName() %></td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td name = "receiver_phone"  class="ct_write01"><%=purchaseVO.getReceiverPhone() %></td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
